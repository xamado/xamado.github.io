...
- Graphics and Rendering (OpenGL, Nintendo Wii's GX, DirectX)
- Torque, Unity, Unreal

### Other

- PHP, MySQL, CSS, JS, Vuejs, node.js, mongodb, redis
- Some Experience: Python, Lua, Rust, Assembly
- Linux. Although nowadays it's mostly through WSL... still no games in Linux :(
...
I developed our own messaging queue system supporting unicast and multicast events on top of Redis.

I also did front end web development (CSS, JS, and all the related awful technologies, heh), iOS (objective-c), C++ (cpu intensive video processing) and Java.
...
Worked on Warner's DC Legends mobile game, on-site at the Warner San Francisco offices. Implemented game play features in Unity and helped the backend team with the node.js server since I already had some previous experience with it and node.js was new to them.
...
Also worked on some server components built on top of node.js.
...
Additionally we also worked for Garage Games Inc. porting Torque Game Engine, Torque 3D, and Torque 2D to the Wii and PSP consoles, effort in which I personally developed all of the rendering tech and most of the low level platform code (the total engine porting team was a whopping 2 devs)
